	...
	for (let type in amounts)
		{
			if (this.tutorialRequest)
			{
				...
				cmpTrigger.CallEvent("OnResourceCountUpdated", {"resourceType": type, "amount" : amounts[type], "resourceCount" : this.resourceCount[type]});
			}
...
Player.prototype.RequestFromTutorialScript = function()
{
	this.tutorialRequest = true;
}

Player.prototype.CancelRequest = function()
{
	this.tutorialRequest = false;
}
