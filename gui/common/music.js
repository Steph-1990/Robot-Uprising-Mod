...
Music.prototype.DEFAULT_MENU_TRACKS = [
	"A_Peace_that_never_Rise.ogg"
];

Music.prototype.DEFAULT_PEACE_TRACKS = [
	"March.ogg",
	"When_they_will_break_the_ice.ogg"
];
...
Music.prototype.updateState = function()
{
	if (this.currentState != this.oldState)
	{
		...
		case this.states.VICTORY:
			...
			setTimeout(Engine.ClearPlaylist,5000);
			setTimeout(this.startPeacePlayList,10000);
			break;
...
Music.prototype.startPeacePlayList = function()
{
