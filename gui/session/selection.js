...
//Check if tutorial has been launched by the player
var tutorialIsLaunched = Engine.GuiInterfaceCall("GetTutorialIsLaunched");
...
EntitySelection.prototype.addList = function(ents, quiet, force = false, addFormationMembers = true)
{
	...
	for (const ent of addFormationMembers ? this.addFormationMembers(ents) : ents)
	{
		...
		if (tutorialIsLaunched)
			Engine.GuiInterfaceCall("SetEntitiesSelection",  {"size": ents.length, "entity": entState.id});
