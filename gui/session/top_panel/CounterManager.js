...
class CounterManager
{
	...
	init()
	{
		...
		let playerCiv = Engine.GuiInterfaceCall("GetPlayerCiv", playerID); 

		for (let counter of this.counters)
		{
			if(counter.resCode === "population")
			{
				counter.icon.sprite = "stretched:session/icons/population/" + playerCiv + "/" + counter.resCode + ".png";
